                                                ...
                                                <div className={`p-6 rounded-[2rem] border transition-all duration-500 ${hashVerified ? "bg-success/[0.03] border-success/20" : "bg-muted/30 border-border"}`}>
                                                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                                                    ...
                                                    <button
                                                      ...
                                                      className={`inline-flex items-center justify-center gap-2 px-8 py-3 rounded-xl text-xs font-bold transition-all active:scale-[0.98] disabled:opacity-50 ${hashVerified
